...
import 'package:fire_guard_app/src/features/profile/presentation/profile_bloc/profile_bloc.dart';
                                  ...
                                  child: isTaskCompleted
                                      ...
                                      : OutlinedButton(
                                          ...
                                          child: Text(
                                            'Cancel Task',
                                            style:
                                                StylesManager.interFontFamilyMedium(
                                              fontSize: 14,
                                              color: ColorsManager.primaryColor,
                                            ),
                                          ),
                                  ...
                                  builder: (context, state) {
                                    if (state is UpdateFireStatusInitial) {
                                      return ElevatedButton(
                                        ...
                                        onPressed: () {
                                          context.read<UpdateFireStatusBloc>().add(
                                                UpdateFireStatus(
